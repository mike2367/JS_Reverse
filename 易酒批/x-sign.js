...
const dom = new JSDOM('<!DOCTYPE html><p>Test</p>', {
    url: "https://www.yijiupi.com/#/index/list?searchKey=%E5%90%8D%E9%85%92"
});
...
global.PluginArray = window.PluginArray;
...
function get(){
    headers = {"cityId":402,"countyRegionId":"320116","userClassId":1,"userDisplayClass":0,"addressId":"","deviceType":3};
    return initInterAuth(headers);
}
console.log(get());
